...
# ./perform-workloads-kml.sh seq_workload rand_workload mount_point db_bench_path db_bench_path2
...
#debug
#reads[readseq]=2000000
#times[readseq]=5
#reads[readreverse]=2000000
#times[readreverse]=5
#reads[readrandom]=100000
#times[readrandom]=5
#reads[readrandomwriterandom]=10000
#times[readrandomwriterandom]=5
...
#./run-workload.sh $1 ${reads[$1]} 1 /tmp/detail.txt $4 $3/rocksdb_bench &
#./run-workload.sh $2 ${reads[$2]} 1 /tmp/detail2.txt $5 $3/rocksdb_bench2 &
